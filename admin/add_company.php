...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2">Ajouter un Annonceur</h1>
    ...
    <div style="width: 60%; margin-left: 20%; background-color: #f2f4f4;">
        ...
        <form action="" method="post" style="margin: 3%; padding: 3%;" name="Company_form" id="Company_form">
            ...
            <div class="form-group">
                <label for="Customer Name">Nom de l'annonceur</label>
                <input type="text" name="Company" id="Company" class="form-control" placeholder="Nom de votre Société">
            </div>

            <div class="form-group">
                <label for="Customer Descritpion">Description</label>
                <textarea name="Description" id="Description" class="form-control" cols="30" rows="10"></textarea>
            </div>

            <div class="form-group">
                <label for="Customer Descritpion">Sélectionnez votre email</label>
